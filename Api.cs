...
namespace AbilityApi
{
    public class Api
    {
        public delegate T ReCreateGameObject<T>() where T : MonoUpdatable;
        ...
        public static T ConstructInstantAbility<T>(string name) where T : MonoUpdatable
        {
            ...
            ReCreateGameObjects.Add(() => ConstructInstantAbility<T>(name));
            return (T)updatable;
        }
        public static T ConstructAbility<T>(string name, string namespaceName, string playerSpriteFileName) where T : MonoUpdatable
        {
            ...
            SpriteRenderer spriteRenderer = parent.AddComponent<SpriteRenderer>();
            ...
            ReCreateGameObjects.Add(() => ConstructAbility<T>(name, namespaceName, playerSpriteFileName));
            return (T)updatable;
        }
